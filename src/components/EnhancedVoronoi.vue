<template>
  <div class="enhanced-voronoi">
    <div class="title">
      <h3>Enhanced Voronoi + Road</h3>
    </div>
    <div id="enhanced-voronoi-map"></div>
  </div>
</template>
